                  ...
                  <div className="space-y-5">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mb-6">
                      ...
                      <p className="text-sm text-blue-700">
                        Family uses smart contracts to ensure secure and transparent agreements between surrogates and intended parents. Your compensation and medical expenses will be stored in an escrow account with milestone-based releases.
                      </p>
                    </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-gray-600 space-y-1">
                    ...
                    <p>• Questions? Contact us at surrogacy@family.eth</p>
                  </div>
                </div>
              </div>
            </div>
