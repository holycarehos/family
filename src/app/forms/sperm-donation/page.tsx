      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-2">
            <Image src="/images/logo.svg" alt="Family Logo" width={32} height={32} className="w-8 h-8" />
            <span className="text-xl font-bold text-blue-600">Family</span>
          </div>
        </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mb-6">
                      ...
                      <p className="text-sm text-blue-700">
                        Family uses blockchain technology to securely verify and store donor information. Your identity will remain anonymous to recipients, but all medical information will be cryptographically verified for authenticity.
                      </p>
                    </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-gray-600 space-y-1">
                    ...
                    <p>• Selected donors receive compensation of 0.5 HBAR per successful donation</p>
                    <p>• All donor information is securely stored on our blockchain platform</p>
                    <p>• Questions? Contact us at donors@family.eth</p>
                  </div>
                </div>
              </div>
            </div>
