    ...
    const fetchServices = async () => {
      ...
      setServices([
        ...
        },
        {
          ...
          currency: 'USD',
          duration: '2-3 weeks',
          imageUrl: 'https://kjkhospital.com/wp-content/uploads/2019/02/Egg_Freezing-960x648-1-768x518.jpg',
          isActive: true,
          isTokenized: true,
        ...
        },
        {
          ...
          currency: 'USD',
          duration: '2-3 weeks',
          imageUrl: 'https://www.geneticclinic.com.au/wp-content/uploads/genetic-test-landscape.jpg',
          isActive: true,
          isTokenized: false,
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <span className="text-lg font-semibold text-gray-900">
                      {service.currency === 'HBAR' ? 'HBAR ' : '$'}{service.price.toLocaleString()}
                    </span>
                    <span className="text-sm text-gray-500 ml-1">
                      {service.currency === 'HBAR' ? 'HBAR' : 'USD'}
                    </span>
                  </div>
