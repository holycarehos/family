                ...
                {step === 3 && (
                  <div className="space-y-5">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mb-6">
                      <h3 className="font-bold text-blue-800 mb-2">Family Commitment</h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <label htmlFor="agreeToContact" className="ml-3 text-sm text-gray-700">
                          I consent to be contacted by Family representatives regarding my fertility treatment options *
                        </label>
                      </div>
                    </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm text-gray-600 space-y-1">
                    ...
                    <p>• Crypto payments accepted (HBAR, USDC) with 5% discount</p>
                    <p>• Questions? Contact us at fertility@family.eth</p>
                  </div>
                </div>
              </div>
            </div>
